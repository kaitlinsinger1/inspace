...
setwd('~/workspace/external_data')
crime_risk_raw<-read.csv('crimerisk_seattle.csv')
head(crime_risk_raw)
colnames(crime_risk_raw)
```
...
write_csv(processed_dataframe, 'external_data/processed_crime_risk.csv')
}
...
external_data_name_to_info_list <- list(
        crime_risk=list(vector_of_expected_downloaded_file_name=c("external_data/crimerisk_seattle.csv"),
