...
observeEvent(input$pull_acs,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_acs.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/acs_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_acs.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/acs_missingness.csv')
...
observeEvent(input$pull_walk,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_walk.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/walk_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_walk.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/walk_missingness.csv')
...
observeEvent(input$pull_cdc,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_cdc.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/cdc_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_cdc.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/cdc_missingness.csv')
...
observeEvent(input$pull_mrfei,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_mrfei.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/mrfei_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_mrfei.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/mrfei_missingness.csv')
    #Some results
  }) %...>% result_val()
...
observeEvent(input$pull_parks,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_parks.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/parks_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_parks.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/parks_missingness.csv')
...
observeEvent(input$pull_crimerisk,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_crimerisk.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/crimerisk_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_crimerisk.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/crimerisk_missingness.csv')
    #Some results
  }) %...>% result_val()
...
observeEvent(input$pull_sidewalk,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_sidewalk.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/sidewalk_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_sidewalk.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/sidewalk_missingness.csv')
...
observeEvent(input$pull_rpp,{
  ...
  for(y in 1:length(years)){
    ...
    # export summary tables
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_rpp.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/rpp_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_rpp.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/rpp_missingness.csv')
...
observeEvent(input$pull_gentrification,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_gentrification.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/gentrification_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_gentrification.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/gentrification_missingness.csv')
...
observeEvent(input$pull_nlcd,{
  ...
  result <- future({
    ...
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_nlcd.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_summary(.), '~/workspace/Inspace/data_pull_measures/nlcd_summary.csv')
    write.csv(read.csv('~/workspace/Inspace/data_pull_measures/dataset_nlcd.csv')%>%dplyr::select(id, radius, year, everything())%>%
                dplyr::select(-X)%>%mutate_all(round, digits=3)%>%table_missingness(.), '~/workspace/Inspace/data_pull_measures/nlcd_missingness.csv')
...
create_report_function<-function(filepath_summary, filepath_missingness){
  if(file.exists(filepath_summary)){
    ...
    dd2 <- ggplot() + annotation_custom(tableGrob(read.csv('~/workspace/Inspace/data_pull_measures/walk_missingness.csv'))) + 
...
pdf('~/workspace/Inspace/data_pull_measures/data_summary.pdf')

create_report_function('~/workspace/Inspace/data_pull_measures/acs_summary.csv', '~/workspace/Inspace/data_pull_measures/acs_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/walk_summary.csv', '~/workspace/Inspace/data_pull_measures/walk_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/cdc_summary.csv', '~/workspace/Inspace/data_pull_measures/cdc_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/nlcd_summary.csv', '~/workspace/Inspace/data_pull_measures/nlcd_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/mrfei_summary.csv', '~/workspace/Inspace/data_pull_measures/mfrei_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/parks_summary.csv', '~/workspace/Inspace/data_pull_measures/parks_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/crimerisk_summary.csv', '~/workspace/Inspace/data_pull_measures/crimerisk_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/sidewalk_summary.csv', '~/workspace/Inspace/data_pull_measures/sidewalk_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/rpp_summary.csv', '~/workspace/Inspace/data_pull_measures/rpp_missingness.csv')
create_report_function('~/workspace/Inspace/data_pull_measures/gentrification_summary.csv', '~/workspace/Inspace/data_pull_measures/gentrifiction_missingness.csv')
dev.off()
})
