...
parks_years<-c(2021)
parks_selected_years<-c(2021)

parks_description<-'The ParkServe dataset contains geographical information of parks in the US. Data is provided for download in a variety of file formats and configuration.'
