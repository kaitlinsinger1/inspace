...
places2020url='https://chronicdata.cdc.gov/api/views/ib3w-k9rq/rows.csv?accessType=DOWNLOAD' #2018, 2017 data
places2021url='https://chronicdata.cdc.gov/api/views/yjkw-uj5s/rows.csv?accessType=DOWNLOAD' #2018, 2019

```

If you are seeking data prior to 2019, are are looking only for data from the 500 largest cities, you can access the 500 Cities data. For a list of cities included visit this link: 
https://www.cdc.gov/places/about/500-cities-2016-2019/pdfs/500-cities-by-state.pdf

```{r cities data, eval=FALSE}

cities2019url='https://chronicdata.cdc.gov/api/views/k86t-wghb/rows.csv?accessType=DOWNLOAD' #2016, 2017 BRFSS data
cities2018url='https://chronicdata.cdc.gov/api/views/k25u-mg9b/rows.csv?accessType=DOWNLOAD' #2015, 2016 data
cities2017url='https://chronicdata.cdc.gov/api/views/kucs-wizg/rows.csv?accessType=DOWNLOAD' #2014, 2015 data
cities2016url='https://chronicdata.cdc.gov/api/views/5mtz-k78d/rows.csv?accessType=DOWNLOAD' #2013, 2014 data
...
download_file_places <- function () {
  ...
  if(year==2020){
    download.file(url = places2020url, destfile = "external_data/downloaded_places.csv")
  }
  if(year==2021){
    download.file(url = places2021url, destfile = "external_data/downloaded_places.csv") 
  }
...
var.cols<-data.frame(matrix(nrow=nrow(dataset1), ncol=(length(places_vars)))) #create dataset of columns
...
years <- c(2018) #set the year for the data of interest
...
environmental_measures$names[6]
names_of_variables_to_get
dataset_radius[["total_pop_count"]][1]  
